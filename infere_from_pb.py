...
def main(argv=None):
    ROOT_DIR = os.getcwd()
    #with tf.gfile.FastGFile("./tmp/blitznet_frozen_model.pb", 'rb') as f:
...
def mold_inputs(images):
        ...
        for image in images:
           ...
           # if image.shape[0] == inference_config.IMAGE_MIN_DIM and image.shape[1] == inference_config.IMAGE_MAX_DIM:
            #    molded_image = image
            print(image.shape)
